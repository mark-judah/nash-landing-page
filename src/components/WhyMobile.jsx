    ...
    return (
        <div className="mt-10">
            <div className="flex items-center p-4">
                ...
                <p className="text-[#0E2954] dark:text-white text-2xl">Why Choose Us</p>
            </div>
            ...
            <div className="flex flex-col items-center p-6">
                ...
                <div class="flex gap-x-3">
                    ...
                    <div class="grow pt-0.5 pb-12">
                        ...
                        <p class="text-sm mt-1  text-[#0E2954] dark:text-white">
                            Enjoy our lightning-fast APIs that make<br />
                            your user experience heaven on earth.<br />
                            You don't have to feel extra pain paying
                            your bills.
                        </p>
                    </div>
                </div>
